...
export default function MobileHeader() {
  return (
    <header className="md:hidden bg-gradient-to-r from-pink-500 to-pink-600 text-white px-4 pt-4 pb-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-pink-100">Apa yang bisa kami bantu hari ini?</p>
      </div>
    </header>
  );
}
